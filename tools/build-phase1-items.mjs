...
const idOverrides = {
  ...
  SlashingBurst: "book-slashing-burst",
  EvilDragonRing1: "evil-dragon-ring-1",
  EvilDragonRing2: "evil-dragon-ring-2",
  EvilDragonRing3: "evil-dragon-ring-3",
  DragonNecklace1: "dragon-necklace-1",
  DragonNecklace2: "dragon-necklace-2",
  DragonNecklace3: "dragon-necklace-3",
  GoldenDragonBrace1: "golden-dragon-bracelet-1",
  GoldenDragonBrace2: "golden-dragon-bracelet-2",
  GoldenDragonBrace3: "golden-dragon-bracelet-3",
  BluishGreenBloodSlaughterPike: "slaughter-pike",
  RDragonRing1: "r-dragon-ring-1",
  RDragonRing2: "r-dragon-ring-2",
  RDragonRing3: "r-dragon-ring-3",
  EvilDragonBracelet1: "evil-dragon-bracelet-1",
  EvilDragonBracelet2: "evil-dragon-bracelet-2",
  EvilDragonBracelet3: "evil-dragon-bracelet-3",
  DragonPendant1: "evil-dragon-necklace-1",
  DragonPendant2: "evil-dragon-necklace-2",
  DragonPendant3: "evil-dragon-necklace-3",
  Fury: "book-fury",
...
const nameOverrides = {
  ...
  StoneHeart: "Stone Heart",
  AwakeningSoul0: "Awakening Soul",
  "GonRyunHolyLightSword(?)": "Holy Light Sword",
  "GonRyunHolyLightSword(?)1": "Holy Light Sword",
  "GonRyunHolyLightSword(?)2": "Holy Light Sword",
  "GonRyunHolyLightSword(?)3": "Holy Light Sword",
  EvilDragonRing1: "Red Dragon Ring",
  EvilDragonRing2: "Red Dragon Ring",
  EvilDragonRing3: "Red Dragon Ring",
  DragonNecklace1: "Dragon Necklace",
  DragonNecklace2: "Dragon Necklace",
  DragonNecklace3: "Dragon Necklace",
  GoldenDragonBrace1: "Golden Dragon Bracelet",
  GoldenDragonBrace2: "Golden Dragon Bracelet",
  GoldenDragonBrace3: "Golden Dragon Bracelet",
  BluishGreenBloodSlaughterPike: "Slaughter Pike",
  RDragonRing1: "Evil Dragon Ring",
  RDragonRing2: "Evil Dragon Ring",
  RDragonRing3: "Evil Dragon Ring",
  EvilDragonBracelet1: "Evil Dragon Bracelet",
  EvilDragonBracelet2: "Evil Dragon Bracelet",
  EvilDragonBracelet3: "Evil Dragon Bracelet",
  DragonPendant1: "Evil Dragon Necklace",
  DragonPendant2: "Evil Dragon Necklace",
  DragonPendant3: "Evil Dragon Necklace",
};
