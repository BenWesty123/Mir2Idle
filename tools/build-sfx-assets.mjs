...
const groups = [
  ...
  },
  {
    ...
    entries: [
      ...
      spellSound("spell.SummonHolyDeva.cast", "Summon Holy Deva cast", 80, 0),
  ...
  },
  {
    ...
    entries: [
      ...
      ...monsterSounds("Hell Slasher", 215),
      ...monsterSounds("Hell Pirate", 216),
      ...monsterSounds("Hell Cannibal", 217),
      ...
      ...monsterSounds("Ghastly Leecher", 152, { attack: 1531, flinch: 1532, death: 1533 }),
      ...monsterSounds("Cyano Ghast", 153),
      ...monsterSounds("Mutated Manworm", 154),
      ...
      // Red Valley KR — Crystal RedMoonEvil (Mon62): 062-1/2/3 attack/flinch/death.
      ...monsterSounds("Red Moon Evil", 62),
      ...monsterSounds("Bomb Spider", 50),
      ...monsterSounds("Root Spider", 51),
      ...monsterSounds("Spider Bat", 52),
      ...monsterSounds("Venom Spider", 53),
      ...monsterSounds("Gang Spider", 54),
      ...monsterSounds("Great Spider", 55),
      ...monsterSounds("Lure Spider", 56),
      ...monsterSounds("Big Ape", 57),
      ...monsterSounds("Evil Ape", 58),
      ...monsterSounds("Grey Evil Ape", 59),
      ...monsterSounds("Red Evil Ape", 60),
      ...monsterSounds("Crystal Spider", 61),
  ...
  },
  {
    ...
    entries: [
      ...
      sound("map.fire", "Hell Cavern map lava burst", 8302),
    ],
  },
  {
    id: "ui-items",
