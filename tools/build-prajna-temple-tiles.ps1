param(
  ...
  [string]$OutputSheet = "../public/maptiles/prajna-temple.png",
  [string]$SetId = "prajna-temple",
  [string]$Label = "Prajna Temple",
  # Crystal D2071/D2072 walkable back tiles. 1950-1954 export black in Tiles.Lib;
  # the visible Prajna temple floor is the 3100-3104 group.
  [int[]]$Frames = @(3100, 3101, 3102, 3103, 3104)
)
...
$byFrame = @{}
foreach ($tile in (Export-TileRange 3098 12 "prajna-temple-tiles-build")) {
...
Write-Host "Prajna Temple tiles: $($tiles.Count) slots ($slotWidth x $slotHeight)"
