param(
  ...
  [string]$OutputSheet = "../public/maptiles/hell-cavern-1.png",
  [string]$SetId = "hell-cavern-1",
  [string]$Label = "Hell Cavern 1",
  # Crystal HELL01 walkable back tiles (Tiles.Lib 3450-3454).
  [int[]]$Frames = @(3450, 3451, 3452, 3453, 3454)
)
...
$byFrame = @{}
foreach ($tile in (Export-TileRange 3448 10 "hell-cavern-1-tiles-build")) {
...
Write-Host "Hell Cavern 1 tiles: $($tiles.Count) slots ($slotWidth x $slotHeight)"
