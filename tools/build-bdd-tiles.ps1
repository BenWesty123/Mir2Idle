param(
  ...
  [string]$OutputSheet = "../public/maptiles/bdd-dungeon.png",
  [string]$SetId = "bdd-dungeon",
  [string]$Label = "Black Dragon Dungeon",
  # Crystal D2001 walkable back tiles (map stores 1950-1954; visible art is 2950-2954).
  [int[]]$Frames = @(2950, 2951, 2952, 2953, 2954)
)
...
$byFrame = @{}
foreach ($tile in (Export-TileRange 2948 12 "bdd-tiles-build")) {
...
Write-Host "BDD tiles: $($tiles.Count) slots ($slotWidth x $slotHeight)"
