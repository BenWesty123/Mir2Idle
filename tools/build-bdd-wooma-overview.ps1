param(
  ...
  [string]$OutputRoot = "../tile-review/bdd-wooma-overview",
  [string]$MapTitle = "WoomaPalace",
  [string]$MapLabel = "Wooma Palace (BDD 4F)",
  [string]$ImagePrefix = "d2006-overview",
  [int]$CropX = 0,
  [int]$CropY = 0,
  [int]$CropWCells = 0,
  [int]$CropHCells = 0,
...
# Crystal WoomaPalace (D2006) - next room after Purgatory Hall (D2005).
$markers = @(
  @{ x = 49; y = 51; className = "hub"; title = "Center hub - Ghoul21 / WoomaGuardian6 / King Scorpion" },
  @{ x = 33; y = 33; className = "spawn"; title = "North pocket - Ghoul21 / ZumaArcher21 / BugBat" },
  @{ x = 19; y = 29; className = "spawn"; title = "North section wave arena (BDD 5F)" },
  @{ x = 69; y = 71; className = "spawn"; title = "East pocket - RedBoar / WoomaGuardian6" },
  @{ x = 19; y = 21; className = "entry"; title = "Entry from Purgatory Hall (D2005)" },
  @{ x = 16; y = 21; className = "exit"; title = "Exit forward to HwanMaJin (D2007)" }
)
...
<body>
  <main>
    ...
    <ul>
      ...
      <li>Orange dot = center hub (49, 51) - main respawn cluster incl. King Scorpion</li>
      <li>Blue dots = north (33, 33) and east (69, 71) farming pockets</li>
      <li>Green dot = entry from Purgatory Hall (19, 21)</li>
      <li>Purple dot = exit forward to HwanMaJin (16, 21)</li>
      <li>Click anywhere to copy coordinates, then reply: <code>use bdd wooma spot X, Y</code></li>
    </ul>
    <div class="toolbar">
    ...
    <div class="legend">
      ...
      <span><i class="dot" style="background:#2ecc71"></i> Entry from Purgatory</span>
      <span><i class="dot" style="background:#9b59b6"></i> Exit to HwanMaJin</span>
    </div>
  </main>
  <script>
    const meta = {
