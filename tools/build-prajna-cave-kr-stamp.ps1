...
$sheetPath = Join-Path $outRoot "prajna-cave-kr-center-stamp.png"
...
$stamp = [ordered]@{
  id = "prajna-cave-kr-center"
  label = "Prajna Cave KR Center"
  sheet = "prajna-cave-kr-center-stamp.png"
  slotWidth = $slotWidth
...
if (Test-Path $indexPath) {
  ...
  $existingStamps = @($parsed.stamps | Where-Object { $_.id -ne "prajna-cave-kr-center" })
}
