param(
  ...
  [string[]]$MapNames = @("D501.map", "D502.map", "D503.map", "D504.map", "D505.map"),
  [string]$OutputRoot = "../tile-review/zuma-temple-prop-catalog",
...
$metadata = [ordered]@{
  title = "Zuma Temple Prop Catalog"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Zuma Temple Prop Catalog</title>
    <style>
  ...
  <body>
    <header>
      <h1>Zuma Temple Prop Catalog</h1>
...
Write-Output "Zuma Temple catalog: $($renderedGroups.Count) decorations"
