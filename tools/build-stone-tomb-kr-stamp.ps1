param(
  ...
  [string]$MapPath = "C:/Users/bb-we/Documents/Crystal-master/Next/NextClient/Map/D717.map",
...
$sheetPath = Join-Path $outRoot "stone-tomb-kr-center-stamp.png"
...
$stamp = [ordered]@{
  id = "stone-tomb-kr-center"
  label = "Stone Tomb KR Center"
  sheet = "stone-tomb-kr-center-stamp.png"
  slotWidth = $slotWidth
...
if (Test-Path $indexPath) {
  ...
  $existingStamps = @($parsed.stamps | Where-Object { $_.id -ne "stone-tomb-kr-center" })
}
