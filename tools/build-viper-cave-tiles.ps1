param(
  ...
  [string]$OutputSheet = "../public/maptiles/viper-cave.png",
  [string]$SetId = "viper-cave",
  [string]$Label = "Viper Cave",
  # Crystal SnakePre/SnakePre2 walkable back tiles (Tiles.Lib 2951-2955).
  [int[]]$Frames = @(2951, 2952, 2953, 2954, 2955)
)
...
$byFrame = @{}
foreach ($tile in (Export-TileRange 2949 12 "viper-cave-tiles-build")) {
...
Write-Host "Viper Cave tiles: $($tiles.Count) slots ($slotWidth x $slotHeight)"
