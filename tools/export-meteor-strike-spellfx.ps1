param(
  ...
  [string]$OutputRoot = "../public/spellfx/MeteorStrike"
)
...
try {
  # PlayerObject cast: Magic2 1590 x10
  $cast = Export-SpellLayer -Lib $lib -Start 1590 -Count 10 -SheetName "l0.png"
  # SpellObject rain overlay: Magic2 1600 x10, 800ms cycle (PlayerObject impact SFX +1/+2)
  $storm = Export-SpellLayer -Lib $lib -Start 1600 -Count 10 -SheetName "storm.png"
  # SpellObject ground body: Magic2 1610 x30, 100ms/frame (3s field)
  $ground = Export-SpellLayer -Lib $lib -Start 1610 -Count 30 -SheetName "ground.png"
  ...
  $atlas = [ordered]@{
    ...
    storm = [ordered]@{
      sheet = $storm.sheet
      interval = 80
      slotWidth = $storm.slotWidth
      slotHeight = $storm.slotHeight
      library = "Magic2"
      baseIndex = 1600
      anchor = "enemy"
      delayMs = 0
