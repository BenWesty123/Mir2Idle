param(
  ...
  [string[]]$MapNames = @("D2001.map"),
  [string]$OutputRoot = "../tile-review/bdd-prop-catalog",
...
$metadata = [ordered]@{
  title = "Black Dragon Dungeon Prop Catalog"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Black Dragon Dungeon Prop Catalog</title>
    <style>
  ...
  <body>
    <header>
      <h1>Black Dragon Dungeon Prop Catalog</h1>
...
Write-Output "BDD prop catalog: $($renderedGroups.Count) decorations"
