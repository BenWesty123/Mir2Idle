param(
  [string]$CatalogRoot = "../tile-review/prajna-cave-prop-catalog",
  [int[]]$AssemblyNumbers = @(22, 33, 37, 39, 40, 41, 42, 43, 45, 72, 77, 78),
  [string]$OutputRoot = "../public/mapobjects",
  [string]$SheetName = "prajna-cave-catalog.png",
  [string]$SetId = "prajna-cave-catalog",
  [string]$Label = "Prajna Cave Catalog Decor"
)
...
try {
  ...
  Write-Host "Prajna Cave decoration sheet: $sheetPath ($slotWidth x $slotHeight, $($objects.Count) slots)"
