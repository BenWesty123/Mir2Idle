param(
  ...
  [string]$MapPath = "C:/Users/bb-we/Documents/Crystal-master/Next/NextClient/Map/D515.map",
...
$sheetPath = Join-Path $outRoot "zuma-temple-kr-center-stamp.png"
...
$stamp = [ordered]@{
  id = "zuma-temple-kr-center"
  label = "Zuma Temple KR Center"
  sheet = "zuma-temple-kr-center-stamp.png"
  slotWidth = $slotWidth
...
if (Test-Path $indexPath) {
  ...
  $existingStamps = @($parsed.stamps | Where-Object { $_.id -ne "zuma-temple-kr-center" })
}
