...
# Crystal KingScorpion: AttackRange1 at MirAction 14; ranged VFX at 544 + direction * 8.
$actions = [ordered]@{
  ...
  projectile = @{ start = (544 + ($Direction * 8)); count = 8; offset = 0; interval = 30 }
}
...
Write-Output "Built King Scorpion combat atlas $Index ($($frames.Count) slots, ${slotWidth}x${slotHeight})"
