param(
  ...
  [string]$MapPath = "C:/Users/bb-we/Documents/Crystal-master/Next/NextClient/Map/DM002.map",
...
$sheetPath = Join-Path $outRoot "kings-tomb-center-stamp.png"
...
$stamp = [ordered]@{
  id = "kings-tomb-center"
  label = "Kings Tomb Center"
  sheet = "kings-tomb-center-stamp.png"
  slotWidth = $slotWidth
...
if (Test-Path $indexPath) {
  ...
  $existingStamps = @($parsed.stamps | Where-Object { $_.id -ne "kings-tomb-center" })
}
