param(
  ...
  [string]$MapPath = "C:/Users/bb-we/Documents/Crystal-master/Next/NextClient/Map/D2008.map",
  [string]$OutputRoot = "../tile-review/bdd-noble-hog-overview",
  [string]$MapTitle = "NobleHogPalace",
  [string]$MapLabel = "Noble Hog Palace (BDD 7F–8F)",
  [string]$ImagePrefix = "d2008-overview",
  [int]$CropX = 0,
  [int]$CropY = 0,
  [int]$CropWCells = 0,
  [int]$CropHCells = 0,
...
# Crystal Noble Hog Palace (D2008) - next room after HwanMaJin (D2007 exit).
$markers = @(
  @{ x = 49; y = 51; className = "boss"; title = "Center hub - King Hog, ZumaGuardian20, ZumaStatue21" },
  @{ x = 69; y = 71; className = "hub"; title = "East pocket - WhiteBoar20/21, ZumaArcher20/21, ZumaStatue20" },
  @{ x = 65; y = 70; className = "spawn"; title = "South pocket wave arena (BDD 7F)" },
  @{ x = 29; y = 32; className = "boss"; title = "North pocket - King Hog boss (BDD 8F)" },
  @{ x = 33; y = 33; className = "hub"; title = "North pocket cluster - Wedge Moth, ZumaArcher21" },
  @{ x = 83; y = 83; className = "entry"; title = "Entry from HwanMaJin (D2007)" },
  @{ x = 26; y = 23; className = "exit"; title = "Exit forward to Sole Spirit Hall (D2009)" },
  @{ x = 83; y = 84; className = "entry"; title = "Alternate entry from D2010 (later BDD section)" }
)
...
<body>
  <main>
    ...
    <ul>
      ...
      <li>Red dot = center hub (49, 51) - King Hog + ZumaGuardian20 / ZumaStatue21</li>
      <li>Orange dot = east pocket (69, 71) - WhiteBoar / ZumaArcher farming cluster</li>
      <li>Blue dot = south pocket wave arena (65, 70) — BDD 7F</li>
      <li>Red dot = north pocket King Hog boss (29, 32) — BDD 8F</li>
      <li>Orange dot = north cluster (33, 33) — Wedge Moth / ZumaArcher21</li>
      <li>Green dots = entry from HwanMaJin (83, 83) and later D2010 link (83, 84)</li>
      <li>Purple dot = exit forward to Sole Spirit Hall (26, 23)</li>
      <li>Click anywhere to copy coordinates, then reply: <code>use bdd noble hog spot X, Y</code></li>
    </ul>
    <div class="toolbar">
    ...
    <div class="legend">
      <span><i class="dot" style="background:#e74c3c"></i> Center hub + King Hog (49, 51)</span>
      <span><i class="dot" style="background:#f39c12"></i> East pocket (69, 71)</span>
      <span><i class="dot" style="background:#3498db"></i> South pocket (65, 70) — BDD 7F waves</span>
      <span><i class="dot" style="background:#e74c3c"></i> North pocket King Hog (29, 32) — BDD 8F</span>
      <span><i class="dot" style="background:#f39c12"></i> North cluster (33, 33)</span>
      <span><i class="dot" style="background:#2ecc71"></i> Entry</span>
      <span><i class="dot" style="background:#9b59b6"></i> Exit to Sole Spirit Hall</span>
    </div>
  </main>
  <script>
    const meta = {
