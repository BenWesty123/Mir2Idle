param(
  ...
  [string]$OutputRoot = "../tile-review/stone-temple-prop-catalog",
...
$metadata = [ordered]@{
  title = "Stone Temple Prop Catalog"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Stone Temple Prop Catalog</title>
    <style>
  ...
  <body>
    <header>
      <h1>Stone Temple Prop Catalog</h1>
...
Write-Output "Stone Temple catalog: $($renderedGroups.Count) decorations"
